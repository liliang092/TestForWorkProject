...
@property (nonatomic, strong) NSDictionary *rotateDict;

@property (nonatomic, strong) NSArray *typesArray;

//直播开始时间
@property (nonatomic, strong) NSArray *liveStartTimeArray;

//直播开始时间
@property (nonatomic, strong) NSString *liveOnlineCount;
