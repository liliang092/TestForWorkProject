...
- (id)initWithFrame:(CGRect)frame {
    if(self = [super initWithFrame:frame]) {
        ...
        self.titles = [NSMutableArray arrayWithObjects:NSLocalizedString(@"下拉开始刷新",),
...
- (void)layoutSubviews {
    ...
    if(hasCustomView) {
        ...
        CGSize titleSize = [self.titleLabel.text sizeWithFont:self.titleLabel.font
                                                       bySize:CGSizeMake(labelMaxWidth,self.titleLabel.font.lineHeight)];
        
        CGSize subtitleSize = [self.subtitleLabel.text sizeWithFont:self.subtitleLabel.font
                                                             bySize:CGSizeMake(labelMaxWidth,self.subtitleLabel.font.lineHeight)];
...
- (UILabel *)titleLabel {
    if(!_titleLabel) {
        ...
        _titleLabel.text = NSLocalizedString(@"下拉开始刷新",);
