...
#define  DLLastLongitude @"DLLastLongitude"
#define  DLLastLatitude  @"DLLastLatitude"
#define  DLLastCity      @"DLLastCity"
#define  DLLastAddress   @"DLLastAddress"
...
AS_SINGLETON(DLLocationManager);
