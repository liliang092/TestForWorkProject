...
- (id)init
{
    ...
    if ( self )
    {
        ...
        self.cachePath = [NSString stringWithFormat:@"%@/%@/Cache/", [LLSandbox libCachePath], [DLSystemInfo appVersion]];
...
{
    return [NSString stringWithFormat:@"%@/%@/",[LLSandbox docPath],[DLCache sharedInstance].cacheUser];
}
