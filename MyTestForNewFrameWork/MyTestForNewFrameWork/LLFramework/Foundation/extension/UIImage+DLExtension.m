...
{
    return animatedImageWithAnimatedGIFReleasingImageSource(CGImageSourceCreateWithURL(toCF [[NSBundle mainBundle] URLForResource:name withExtension:nil], NULL));
}
