...
@implementation DLSystemInfo

DEF_SINGLETON(DLSystemInfo);
...
{
#if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR || TARGET_OS_MAC)
	Class openUDID = NSClassFromString( @"DLOpenUDID" );
	if ( openUDID )
	{
...
+ (CGSize)mainScaleSize
{
    ...
    return CGSizeMake([self mainScreenSize].width*scale_screen, [self mainScreenSize].height*scale_screen);
}
//当前语言
...
+ (BOOL)isPhone35
{
	...
	{
		return [DLSystemInfo isScreenSize:CGSizeMake(320, 480)];
	}
#else	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
	return NO;
#endif	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
...
+ (BOOL)isPhoneRetina35
{
	...
	{
		return [DLSystemInfo isScreenSize:CGSizeMake(640, 960)];
	}
#else	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
	return NO;
#endif	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
...
+ (BOOL)isPhoneRetina4
{
	...
	{
		return [DLSystemInfo isScreenSize:CGSizeMake(640, 1136)];
	}
#else	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
	return NO;
#endif	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
...
{
#if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
	return [DLSystemInfo isScreenSize:CGSizeMake(768, 1024)];
#else	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
	return NO;
#endif	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
}
...
{
#if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
	return [DLSystemInfo isScreenSize:CGSizeMake(1536, 2048)];
#else	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
	return NO;
#endif	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
}
